...
external_url 'https://gitlab.fathm.io'

# Lets encrypt
nginx['custom_gitlab_server_config'] = "location ^~ /.well-known { root /var/www/letsencrypt; }"

high_availability['mountpoint'] = '/mnt/gitlab'
...
git_data_dirs({"default" => "/mnt/gitlab/data"})
...
gitlab_rails['smtp_user_name'] = "charandas108@gmail.com"
gitlab_rails['smtp_password'] = "REPLACE_ME_ONE_TIME_APP_PASS"
...
registry_external_url 'https://gitlab.fathm.io:4657'
...
# registry['uid'] = nil
# registry['gid'] = nil
registry['dir'] = "/mnt/gitlab/registry"
...
postgresql['data_dir'] = "/mnt/gitlab/postgresql/data"
...
# mattermost_nginx['ssl_session_cache'] = "builtin:1000  shared:SSL:10m" # recommended in https://nginx.org/en/docs/http/ngx_http_ssl_module.html
# mattermost_nginx['ssl_session_timeout'] = "5m" # default according to https://nginx.org/en/docs/http/ngx_http_ssl_module.html
# mattermost_nginx['ssl_dhparam'] = nil # Path to ci_dhparams.pem, eg. /etc/gitlab/ssl/ci_dhparams.pem
# mattermost_nginx['listen_addresses'] = ['*', '[::]']
# mattermost_nginx['listen_port'] = nil # override only if you use a reverse proxy: https://docs.gitlab.com/omnibus/settings/nginx.html#setting-the-nginx-listen-port
# mattermost_nginx['listen_https'] = nil # override only if your reverse proxy internally communicates over HTTP: https://docs.gitlab.com/omnibus/settings/nginx.html#supporting-proxied-ssl
